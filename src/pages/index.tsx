  ...
  return (
    <>
      ...
      <header id="hero" className="w-full lg:h-screen">
        <section className="container mx-auto my-0.5 flex flex-col items-center md:my-24 md:flex-row">
          <div className="flex w-full flex-col items-start justify-center px-6 pb-24 pt-12 lg:w-1/2">
